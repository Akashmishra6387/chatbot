...
patterns_responses = [
    ...
    # Greeting
    [r'Hi|hi|Hello|hello|Hey|hey', ['Hello! Welcome to Pizza hut. How can I help you with your pizza order today?']],
    ...
    # Order Confirmation
    [r'Yes|Confirm|Place order', ['Your order has been placed! We will deliver it to you as soon as possible. Thank you for choosing pizza hut.']],
